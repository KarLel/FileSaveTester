...
public class FileSaveTester extends Task<File>
{
    private final static Logger log = Logger.getLogger(FileSaveTester.class.getName());
    ...
    public FileSaveTester(String remoteUrl, File localFile)
    {
        this(new DefaultHttpClient(), remoteUrl, localFile, DEFAULT_BUFFER_SIZE);
    }

    public FileSaveTester(HttpClient httpClient, String remoteUrl, File localFile, int bufferSize)
    {
